 ...
 */
$settings['file_private_path'] = getenv("DRUPAL_FILE_PRIVATE_PATH")??"sites/default/private";
 ...
 */
$settings['file_temp_path'] = getenv("DRUPAL_FILE_TEMP_PATH")??"sites/default/temp";
 ...
 * its location.
 */
$settings['config_sync_directory'] = getenv("DRUPAL_CONFIG_SYNC_DIR")??"sites/default/config";
